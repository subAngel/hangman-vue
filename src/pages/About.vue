<template>
	<div class="flex justify-center items-center h-screen bg-base-200">
		<div
			class="flex flex-col justify-center max-w-xs p-6 shadow-2xl rounded-xl sm:px-12 bg-gray-50 text-gray-800"
		>
			<img
			...
			<div class="space-y-4 text-center divide-y divide-gray-300">
				...
				<div class="flex justify-center pt-2 space-x-4 align-center">
					<a
						...
						target="_blank"
						href="https://github.com/subAngel"
						aria-label="GitHub"
						class="p-2 rounded-md text-gray-800 hover:text-purple-600"
					>
						<svg
							viewBox="0 0 496 512"
